'''Scrapes tweets from Kpop BTS's timeline using conversation_id'''
import os
import json
import tweepy
...
hundred_tweets = client.get_users_tweets(id=335141638, tweet_fields=['conversation_id','created_at'], max_results=100)
